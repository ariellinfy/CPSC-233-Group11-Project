...
public class GameConfiguration {
	...
	/**
	 * A method determines the status of the game after each move.
	 * It creates an arrayList of stone counts from four directions of the move:
	 * top to bottom, left to right, top left to bottom right, top right to bottom left;
	 * then find the max count out of four directions.
	 * If max count is over the WIN_COUNT constant variable, then the game result in a draw.
	 * If max count is exactly equals WIN_COUNT, then the game has a winner, and
	 * the winner is determined based on the stone color of the current move.
	 * For all other situation (max count is less than WIN_COUNT), the game will continue.
